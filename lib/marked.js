...
(function (global, factory) {
  ...
  var getCounter$1 = function getCounter() {
    return memoCounter;
  };
  ...
  var memoize$1 = memoize_1.memoize;
  /**
   * Helpers
   */
  ...
  var cleanUrl$1 = memoize$1(function (sanitize, base, href) {
    if (sanitize) {
      var prot;
  ...
  var splitCells$1 = memoize$1(function (tableRow, count) {
  ...
  var rtrim$1 = memoize$1(function (str, c, invert) {
    var l = str.length;
  ...
  var findClosingBracket$1 = memoize$1(function (str, b) {
  ...
  var memoize = memoize_1.memoize;
  var outputLink = memoize(function (cap, link, raw) {
    var href = link.href;
  ...
  var indentCodeCompensation = memoize(function (raw, text) {
  ...
  var getCounter = memoize_1.getCounter;
  /**
   * Marked
   */

  function marked(src, opt, callback) {
    console.log("instrumented"); // throw error in case of non string input
    ...
    try {
      ...
      var result = Parser.parse(_tokens, opt);
